  ...
  return (
    <aside className="hidden lg:block lg:col-span-4">
      <div className="sticky top-20 space-y-3">
        ...
        {/* Square Ad 1 */}
        <SidebarSquareAd href="https://pl-go.kelkoogroup.net/permanentLinkGo?country=pl&id=a6b7e7ce-7214-4d99-a180-47a56aa39021&merchantUrl=https%3A%2F%2Fmediamarkt.pl&originReferer=clubmytrip.com&publisherSubId=pld" imgSrc="/ad-banner-1.jpeg" alt="Sony at MediaMarkt" />

        <div className="border-t border-gray-100" />

        {/* Square Ad 2 */}
        <SidebarSquareAd href="https://de-go.kelkoogroup.net/permanentLinkGo?country=de&id=a6b7e7ce-7214-4d99-a180-47a56aa39021&merchantUrl=https%3A%2F%2Fshop.mango.com%2Fde%2Fde%2F&originReferer=clubmytrip.com&publisherSubId=ded" imgSrc="/ad-banner-7.jpeg" alt="Mango" />
