...
/* ============================= BRAND SIDEBAR BANNERS ============================= */
const SIDEBAR_ADS = [
  { src: '/ad-banner-3.jpeg', alt: 'Wayfair', href: 'https://uk-go.kelkoogroup.net/permanentLinkGo?country=uk&id=a6b7e7ce-7214-4d99-a180-47a56aa39021&merchantUrl=https%3A%2F%2Fwww.wayfair.co.uk&originReferer=clubmytrip.com&publisherSubId=ukd' },
  { src: '/ad-banner-4.jpeg', alt: 'MegaBad', href: 'https://de-go.kelkoogroup.net/permanentLinkGo?country=de&id=a6b7e7ce-7214-4d99-a180-47a56aa39021&merchantUrl=https%3A%2F%2Fwww.megabad.com&originReferer=clubmytrip.com&publisherSubId=ded' },
  { src: '/ad-banner-6.jpeg', alt: 'ZooRoyal', href: 'https://de-go.kelkoogroup.net/permanentLinkGo?country=de&id=a6b7e7ce-7214-4d99-a180-47a56aa39021&merchantUrl=https%3A%2F%2Fwww.zooroyal.de&originReferer=clubmytrip.com&publisherSubId=ded' },
];

function BrandSidebarBanners() {
  return (
      ...
      {SIDEBAR_ADS.map((b, i) => (
        <div key={i} className="w-full">
          <div className="flex items-center justify-between mb-1">
            <span className="text-[9px] font-semibold uppercase tracking-[0.13em] text-gray-400">Sponsored</span>
            <span className="bg-gray-100 text-gray-400 text-[8px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded-sm">Ad</span>
          </div>
          <a href={b.href} target="_blank" rel="noopener noreferrer" className="block group">
            <div className="relative w-full aspect-square rounded-xl overflow-hidden border border-gray-200 bg-gradient-to-br from-gray-50 to-white shadow-sm group-hover:shadow-lg group-hover:-translate-y-0.5 transition-all duration-300">
              <img
                ...
                alt={b.alt}
                loading="lazy"
                className="w-full h-full p-2 object-contain group-hover:scale-[1.03] transition-transform duration-500"
              />
            </div>
          </a>
        </div>
...
export default async function BlogPost({ params }: { params: { slug: string } }) {
  ...
  return (
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pb-16">
            ...
            <div className="lg:col-span-8">
              ...
              <article
                className="wp-content prose prose-lg max-w-none text-gray-700
    ...
    hover:[&_.wp-block-button__link]:shadow-lg"
              ...
              {/* Mobile banners — shown below article on small screens */}
